...
{
  BOOST_CHECK_THROW(new openfluid::landr::VectorDataset(CONFIGTESTS_DATA_INPUT_DIR +"/GeoVectorValue/SU.gml"),
                    openfluid::base::FrameworkException);

  BOOST_CHECK_THROW(new openfluid::landr::VectorDataset(CONFIGTESTS_DATA_INPUT_DIR +"/GeoVectorValue/SU.geojson"),
                  openfluid::base::FrameworkException);


  openfluid::core::GeoVectorValue Value(CONFIGTESTS_DATA_INPUT_DIR,"/GeoVectorValue/SU.geojson");

  BOOST_CHECK_THROW(new openfluid::landr::VectorDataset(Value),openfluid::base::FrameworkException);

  openfluid::core::GeoVectorValue Value2(CONFIGTESTS_DATA_INPUT_DIR,"/GeoVectorValue/SU.gml");
...
{
  std::string NewPath =
      openfluid::core::GeoValue::computeAbsolutePath(CONFIGTESTS_DATA_OUTPUT_DIR,
                                                     "OPENFLUID.OUT.VectorDataset/new_test.shp");

  deleteIfExists(NewPath);

  if (!openfluid::tools::Filesystem::isDirectory(CONFIGTESTS_DATA_OUTPUT_DIR + "/OPENFLUID.OUT.VectorDataset"))
  {
    openfluid::tools::Filesystem::makeDirectory(CONFIGTESTS_DATA_OUTPUT_DIR + "/OPENFLUID.OUT.VectorDataset");
  }
  ...
  Vect->copyToDisk(CONFIGTESTS_DATA_OUTPUT_DIR,"OPENFLUID.OUT.VectorDataset/new_test.shp", false);

  openfluid::core::GeoVectorValue NewVal(CONFIGTESTS_DATA_OUTPUT_DIR, "OPENFLUID.OUT.VectorDataset/new_test.shp");

  BOOST_CHECK_EQUAL(NewVal.data()->GetLayer(0)->GetFeatureCount(), 24);

  BOOST_CHECK_THROW(Vect->copyToDisk(CONFIGTESTS_DATA_OUTPUT_DIR, "OPENFLUID.OUT.VectorDataset/new_test.shp", false),
                    openfluid::base::FrameworkException);

  Vect->copyToDisk(CONFIGTESTS_DATA_OUTPUT_DIR,"OPENFLUID.OUT.VectorDataset/new_test.shp", true);
...
{
  openfluid::core::GeoVectorValue ValueSU(CONFIGTESTS_DATA_INPUT_DIR + "/landr/", "badSU_overlap.shp");
...
{
  openfluid::core::GeoVectorValue ValueSU(CONFIGTESTS_DATA_INPUT_DIR + "/landr/", "badSU_non_snapped.shp");
...
BOOST_AUTO_TEST_CASE(check_checkTopology)
{
  ...
  openfluid::core::GeoVectorValue ValueRS(CONFIGTESTS_DATA_INPUT_DIR + "/landr/", "RS_To_Snap.shp");
...
BOOST_AUTO_TEST_CASE(check_snapVertices)
{
  ...
  VectRS->copyToDisk(CONFIGTESTS_DATA_OUTPUT_DIR,"OPENFLUID.OUT.VectorDataset/snapRS.shp", true);


  openfluid::core::GeoVectorValue* ValRS =
    new openfluid::core::GeoVectorValue(CONFIGTESTS_DATA_OUTPUT_DIR+"/OPENFLUID.OUT.VectorDataset","snapRS.shp");
  ...
  openfluid::core::GeoVectorValue ValueSU(CONFIGTESTS_DATA_INPUT_DIR + "/landr/", "SU_To_Snap.shp");
  openfluid::landr::VectorDataset* VectSU = new openfluid::landr::VectorDataset(ValueSU);
...
{
  openfluid::core::GeoVectorValue ValueSU(CONFIGTESTS_DATA_INPUT_DIR + "/landr/", "SU.shp");
  ...
  openfluid::core::GeoVectorValue DuplicateSU(CONFIGTESTS_DATA_INPUT_DIR + "/landr/", "duplicateSU.shp");
...
{
  openfluid::core::GeoVectorValue ValueSU(CONFIGTESTS_DATA_INPUT_DIR + "/landr/", "BAD_POLYGEOM.shp");
