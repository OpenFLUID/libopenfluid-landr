...
{
  openfluid::core::GeoRasterValue Val(CONFIGTESTS_DATA_INPUT_DIR + "/GeoRasterValue", "dem.jpeg");
...
BOOST_AUTO_TEST_CASE(check_getValueOfCoordinate)
{
  ...
  // float values
  Val = openfluid::core::GeoRasterValue(CONFIGTESTS_DATA_INPUT_DIR + "/GeoRasterValue", "dem.asc");
...
BOOST_AUTO_TEST_CASE(check_Polygonize)
{
  ...
  RasterVal = openfluid::core::GeoRasterValue(CONFIGTESTS_DATA_INPUT_DIR + "/GeoRasterValue", "dem.asc");
